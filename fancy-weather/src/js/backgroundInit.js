...
function backgroundInit() {
  // делаю анализ на основании русской локализации
  function getHours() {
  ...
  async function getLinkToImage() {
    ...
    // TODO or portrait
    const url = `https://api.unsplash.com/photos/random?orientation=landscape&per_page=1&query=${informationForImage}&client_id=97468db9ac3f46aba050edeb6ee94ee6c2fa732c4970c3d260cdbf50156a6f44`;
    // const url = `https://api.unsplash.com/photos/random?orientation=landscape&per_page=1&query=${informationForImage}&client_id=e2077ad31a806c894c460aec8f81bc2af4d09c4f8104ae3177bb809faf0eac17`;
